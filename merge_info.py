...
from trainer import testing_loop, training_loop, training_loop_subtask, training_loop_multitask
...
parser.add_argument('--backbone_lr', default=0.001, type=float,
                    metavar='LR', help='initial learning rate')
...
def main():
    ...
    training_loop_multitask(models=[model_ABC, model_AB, model_AC], logger=logger, args=args, save_best=True)
    print('\n', args)
